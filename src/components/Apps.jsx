...
const Apps = () => {
  ...
  <section className="app-section app-sec-one p-0">
    <div className="container">
      <div className="app-bg">
            ...
            <div className="app-content d-flex flex-column justify-content-center">
              ...
              <div className="google-imgs aos" data-aos="fade-up">
                <a href="javascript:void(0);">
                  <img src="/img/icons/app-store-01.svg" alt="img" />
                </a>
                <a href="javascript:void(0);">
                  <img src="/img/icons/google-play-01.svg" alt="img" />
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="app-bgs">
          <img
            src="/img/bg/app-bg-02.png"
            alt="img"
            className="app-bg-01"
          />
          <img
            src="/img/bg/app-bg-03.png"
            alt="img"
            className="app-bg-02"
          />
          <img
            src="/img/bg/app-bg-04.png"
            alt="img"
            className="app-bg-03"
          />
        </div>
    ...
    <div className="download-bg">
      <img src="/img/bg/download-bg.png" alt="img" />
    </div>
  </section>
  {/* /App Section */}
</>
